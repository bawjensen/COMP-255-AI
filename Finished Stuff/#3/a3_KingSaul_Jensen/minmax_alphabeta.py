...
def static_eval(board):
	"""
	Static evaluator for single checkers boards. Places emphasis on the superiority
	of edge spots on the board and places a double weight on those that are occupied.
	"""
	num_edge_c_pieces = 0
