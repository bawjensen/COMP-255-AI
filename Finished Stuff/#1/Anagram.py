...
class Trie():
    ...
    def anagram_finder(self, remainingLetters, stringSoFar="", wordsSoFar=[], children="none"):
        try:
            ...
            self.size_original = len(remainingLetters)
        """
        ...
        for child in children:
            ...
            if child.item in remainingLetters:
                ...
                if child.isWord and newLetters == "":
                    ...
                    if len(wordsSoFar) > 0 and wordsSoFar[-1][0] < newStringSoFar[0] and len(newStringSoFar) >= self.size_original*4/5:
                    ...
                    # single-word anagram
                    elif len(wordsSoFar) == 0 and len(newStringSoFar) >= self.size_original*4/5:
