					The 8-puzzle 
		(code can almost run the 15-puzzle, but not quite).

What is it?
	It's a simple search implementation in python using an 8-puzzle board (implemented with instances of BoardClass) and a module containing all searches. The board is passed to the search function, and what's returned is a list of all steps from the starting board to the goal. 
